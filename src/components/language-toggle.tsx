...
export function LanguageToggle() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-5 right-5 z-[60] inline-flex items-center gap-2 rounded-full bg-[color:var(--brand-orange)] px-4 py-3 text-sm font-semibold text-white shadow-lg hover:bg-[color:var(--brand-charcoal)] focus:outline-none focus-visible:ring-2 focus-visible:ring-white transition-colors ${nextIsArabic ? "" : "uppercase tracking-wider"}`}
