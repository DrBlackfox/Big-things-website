...
export function HeroSlider({
  ...
  return (
    <section
      ...
      dir="ltr"
      tabIndex={0}
      className="relative w-full h-[calc(100dvh-250px)] min-h-[440px] bg-[color:var(--brand-charcoal)] overflow-hidden touch-pan-y select-none cursor-grab active:cursor-grabbing focus:outline-none"
