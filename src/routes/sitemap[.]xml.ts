    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/publicite", changefreq: "monthly", priority: "0.9" },
          { path: "/publicite/publicite", changefreq: "monthly", priority: "0.8" },
          { path: "/publicite/signaletique", changefreq: "monthly", priority: "0.8" },
          { path: "/creations", changefreq: "weekly", priority: "0.7" },
          { path: "/contact", changefreq: "yearly", priority: "0.6" },
          ...publiciteCategories.map((c) => ({
            path: `/publicite/${c.slug}`,
            changefreq: "monthly" as const,
            priority: "0.7",
          })),
          ...publiciteProducts.map((p) => ({
            path: `/publicite/publicite/${p.slug}`,
            changefreq: "monthly" as const,
            priority: "0.6",
          })),
          ...signaletiqueProducts.map((p) => ({
            path: `/publicite/signaletique/${p.slug}`,
            changefreq: "monthly" as const,
            priority: "0.6",
          })),
          ...standProducts.map((p) => ({
