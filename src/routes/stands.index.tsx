...
export const Route = createFileRoute("/stands/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nos gammes de stands d'exposition sur mesure : multimédia, lightbox, menuiserie, toile tendue, parapluie, tubulaire." },
      { property: "og:title", content: "Stands d'exposition — Big Things Decoration" },
      { property: "og:description", content: "Nos gammes de stands d'exposition sur mesure : multimédia, lightbox, menuiserie, toile tendue, parapluie, tubulaire." },
      { property: "og:url", content: abs("/stands") },
    ],
    links: [{ rel: "canonical", href: abs("/stands") }],
  }),
    ...
    <PageShell background="dark">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-10 pb-6">
        ...
        <p className="mt-3 text-white/70 max-w-2xl uppercase tracking-wide text-sm">
          {t("Six gammes de stands sur mesure pour vos salons, showrooms et événements.")}
        </p>
      </div>
